...
class TechnicalAssetPolicy
{
    ...
    public function update(User $user, TechnicalAsset $technicalAsset): bool
    {
        if (!$this->create($user)) {
            return false;
        }

        return $this->sameSector($user, $technicalAsset->sector);
    }

    public function delete(User $user, TechnicalAsset $technicalAsset): bool
    {
        if (!$this->active($user)) {
            return false;
        }
