...
class IndustrialMachinePolicy
{
    ...
    public function update(User $user, IndustrialMachine $industrialMachine): bool
    {
        if (!$this->create($user)) {
            return false;
        }

        return $this->sameSector($user, $industrialMachine->sector);
    }

    public function delete(User $user, IndustrialMachine $industrialMachine): bool
    {
        if (!$this->active($user)) {
            return false;
        }
