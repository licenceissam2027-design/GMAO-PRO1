...
class LogisticAssetPolicy
{
    ...
    public function update(User $user, LogisticAsset $logisticAsset): bool
    {
        if (!$this->create($user)) {
            return false;
        }

        return $this->sameSector($user, $logisticAsset->sector);
    }

    public function delete(User $user, LogisticAsset $logisticAsset): bool
    {
        if (!$this->active($user)) {
            return false;
        }
